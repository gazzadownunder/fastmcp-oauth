// Keycloak Configuration (EXACT COPY from working Sample-client-auth)
...
// MCP Server Configuration (additional for web-test)
const mcpConfig = {
    url: 'http://localhost:3000', // Direct to MCP server (no proxy needed!)
    endpoint: '/mcp'
};
