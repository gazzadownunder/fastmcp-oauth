...
/**
 * @deprecated OAuthOBOServer is deprecated. Please migrate to the new modular architecture:
 * - Use ConfigOrchestrator to build CoreContext
 * - Use MCPAuthMiddleware for authentication
 * - Use createSqlDelegateTool and other tool factories
 * - See examples/ directory for migration guides
 */
export class OAuthOBOServer {
  ...
  constructor() {
    ...
    console.warn('Please migrate to the new modular architecture.');
    console.warn('See documentation for migration guide.\n');
