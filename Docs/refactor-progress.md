...
- [x] Export all from `./core/index.js` ✅
- [x] Export all from `./delegation/index.js` ✅
- [x] Export all from `./mcp/index.js` ✅
- [x] Export selected types from `./config/index.js` (avoiding duplicates) ✅
- [x] Export all from `./utils/errors.js` ✅
- [x] Export `OAuthOBOServer` from `./legacy/index-simple-adapter.js` (deprecated) ✅
- [x] **Validation**: All exports work, no duplicate export errors ✅

#### 5.2 Create Backward Compatibility Adapter ✅
- [x] Create `src/legacy/` directory ✅
- [x] Create `src/legacy/index-simple-adapter.ts` ✅
- [x] Copy original OAuthOBOServer implementation ✅
- [x] Add deprecation warning in constructor ✅
- [x] Add JSDoc deprecation notice ✅
- [x] Update imports to use relative paths from legacy directory ✅
...
- [x] **Validation**: Backward compatibility adapter created ✅

#### 5.3 Create Usage Examples ✅
- [x] Create `examples/` directory ✅
- [x] Create `examples/core-only.ts` ✅
  - [x] Demonstrate standalone auth usage ✅
  - [x] No MCP dependencies ✅
  - [x] Shows AuditService with Null Object Pattern ✅
  - [x] Shows session migration (v0 to v1) ✅
  - [ ] **Test**: Verify example runs (Deferred - compilation verified)
- [x] Create `examples/with-sql-delegation.ts` ✅
  - [x] Demonstrate auth + SQL delegation ✅
  - [x] No MCP dependencies ✅
  - [x] Shows DelegationRegistry usage ✅
  - [x] Shows SQL module registration ✅
  - [ ] **Test**: Verify example runs with mock SQL (Deferred - compilation verified)
- [x] Create `examples/custom-delegation.ts` ✅
  - [x] Demonstrate custom delegation module (API example) ✅
  - [x] Implements DelegationModule interface ✅
  - [x] Shows audit trail integration ✅
  - [x] Complete working example < 200 LOC ✅
  - [ ] **Test**: Verify example compiles (Deferred - compilation verified)
- [x] Create `examples/full-mcp-server.ts` ✅
  - [x] Demonstrate full MCP server with new architecture ✅
  - [x] Shows ConfigOrchestrator usage ✅
  - [x] Shows CoreContext validation ✅
  - [x] Shows tool factory pattern ✅
  - [x] Includes unified config example in comments ✅
  - [ ] **Test**: Verify example runs (Deferred - compilation verified)
- [x] **Validation**: All examples created and compile successfully ✅
